...
void draw3D()
{
    ...
    // offset bottom two points by player position
    int x1 = 40 - P.x;
    int y1 = 10 - P.y;
    ...
    wx[0] = (wy[0] != 0) ? wx[0] * 200 / wy[0] + SW2 : wx[0];
    wx[1] = (wy[0] != 0) ? wx[1] * 200 / wy[1] + SW2 : wx[1];
    wy[0] = (wy[0] != 0) ? wz[0] * 200 / wy[0] + SH2 : wy[0];
    wy[1] = (wy[0] != 0) ? wz[1] * 200 / wy[1] + SH2 : wy[1];
